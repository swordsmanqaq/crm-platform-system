...
public class GenteratorCode {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        ResourceBundle rb = ResourceBundle.getBundle("mybatitsPlus-config-shop"); //不要加后缀
        ...
        strategy.setTablePrefix(new String[] { "t_shop_" });// 此处可以修改为您的表前缀
        strategy.setNaming(NamingStrategy.underline_to_camel);// 表名生成策略
        strategy.setInclude(new String[]{"t_shop_shoping_car"}); // 需要生成的表
