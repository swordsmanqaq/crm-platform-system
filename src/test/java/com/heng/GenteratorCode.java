...
public class GenteratorCode {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        ResourceBundle rb = ResourceBundle.getBundle("mybatitsPlus-config-order"); //不要加后缀
        ...
        strategy.setTablePrefix(new String[] { "t_order_" });// 此处可以修改为您的表前缀
        strategy.setNaming(NamingStrategy.underline_to_camel);// 表名生成策略
        strategy.setInclude(new String[]{"t_order_contract","t_order_contract_remark","t_order_order","t_order_order_activity","t_order_order_product"}); // 需要生成的表
