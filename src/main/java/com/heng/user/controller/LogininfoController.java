...
import com.heng.user.query.LogininfoQuery;
...
public class LogininfoController {
    ...
    */
    ...
    public AjaxResult loadById(@PathVariable("id" ) Long id) {
        try {
            Logininfo logininfo =logininfoService.loadById(id);
            return AjaxResult.me().setResultObj(logininfo);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    */
    ...
    public AjaxResult loadAll() {
        ...
        try {
            List< Logininfo> list = logininfoService.loadAll();
    ...
    */
    @PostMapping
    public AjaxResult pageList(@RequestBody LogininfoQuery query) {
        try {
            PageList<Logininfo> pageList = logininfoService.pageList(query);
