...
import com.heng.finance.query.DepositQuery;
...
public class DepositController {
     ...
     */
    @PutMapping
    public AjaxResult addOrUpdate(@RequestBody Deposit deposit) {
        try {
    ...
    */
    ...
    public AjaxResult patchRemove(@RequestBody List<Long> ids) {
        try {
                depositService.patchRemove(ids);
            return AjaxResult.me();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    */
    ...
    public AjaxResult loadById(@PathVariable("id") Long id) {
        try {
            Deposit deposit =depositService.loadById(id);
    ...
    */
    ...
    public AjaxResult loadAll() {
        ...
        try {
            List< Deposit> list = depositService.loadAll();
    ...
    */
    @PostMapping
    public AjaxResult pageList(@RequestBody DepositQuery query) {
        try {
            PageList<Deposit> pageList = depositService.pageList(query);
